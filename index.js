...
app.post("/", function(req, res) {
    ...
    //build up the URL for the JSON query, API Key is // secret and needs to be obtained by signup 
        ...
        const apiKey = "72460eef98322359cf8a6210bb7a9aa1";
    ...
    https.get(url, function(response){
        ...
        response.on("data", function(data){
            ...
            res.write("<h2>The Temperature in " + city + " "  + cityID + " is " + temp + " Degrees Fahrenheit<h2>");
            res.write("<h2> The Humidity is " + humidity + "%<h2>");
            res.write("<h2> The Wind Speed is " + windSpeed + " mpa." + "The wind Direction is " + windDirection +" <h2>");
            res.write("<h2>The Cloudiness in " + cloudiness + "%<h2>");
